...
def create_ui():
    ...
    def render_frame(fov, look_x, look_y, look_z, time_hr, 
                     use_scat, use_ext, use_shad, use_shine):
        ...
        image_data = renderer.render(
            ...
            time_sec=time_sec, use_scattering=use_scat,
            use_extinction=use_ext, use_shadows=use_shad,
    ...
    with gr.Blocks(title="Ringworld Renderer") as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        scat_toggle = gr.Checkbox(value=True, label="Sky Scattering", info="Rayleigh blue sky")
                        ext_toggle = gr.Checkbox(value=True, label="Extinction", info="Distant haze")
                    with gr.Row():
        ...
        inputs = [fov_slider, look_x, look_y, look_z, time_slider, 
                  scat_toggle, ext_toggle, shad_toggle, shine_toggle]
        
        def reset_view():
            return [110, 1.0, 0.3, 0.0, 0.0, True, True, True, True]

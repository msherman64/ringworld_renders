...
> **Documentation Structure**: This is the complete technical design document. For quick reference, see [Physics Reference](PHYSICS_REFERENCE.md). For system architecture, see [Architecture](ARCHITECTURE.md). For user-facing documentation, see [README.md](../README.md). For development workflow, see [Contributing](../CONTRIBUTING.md).
